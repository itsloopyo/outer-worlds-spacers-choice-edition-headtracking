...
// nothing, and it lives in namespace tow_ht::legacy. config_sanitize.h, the value
// guards it reads through, moved here unchanged.
...
// The shipped crosshair widget list, which Load puts in reticle_targets before
// it reads the file.
extern const char* const kDefaultReticleTargets;
