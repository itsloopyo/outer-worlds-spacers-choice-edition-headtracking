@echo off
:: ============================================
:: Outer Worlds: Spacer's Choice Edition Head Tracking - Uninstall
:: ============================================
...
:: --- CONFIG BLOCK ---
set "GAME_ID=outer-worlds-spacers-choice-edition"
...
set "PRESERVE_FILES=Indiana\Binaries\Win64\CameraUnlock.ini Indiana\Binaries\Win64\HeadTracking.ini"
